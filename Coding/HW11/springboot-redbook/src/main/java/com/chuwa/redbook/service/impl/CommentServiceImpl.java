...
import com.chuwa.redbook.exception.InvalidRequestException;
...
public class CommentServiceImpl implements CommentService {
    ...
    public CommentDto createComment(long postId, CommentDto commentDto) {
        if (commentDto.getBody() == null || commentDto.getBody().trim().isEmpty()) {
            throw new InvalidRequestException("Comment body cannot be empty");
        }
