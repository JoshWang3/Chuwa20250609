...
public class SingletonTest {
    public static void main(String[] args) {
        // hw4.singleton.EagerLoadSingleton Test
        ...
        if (obj1 == obj2) {
            System.out.println("hw4.singleton confirmed: All instances are the same.");
        } else {
            System.out.println("hw4.singleton broken: Instances are different.");
        }
