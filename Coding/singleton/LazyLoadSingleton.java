...
//public class singleton.LazyLoadSingleton {
//    // no instance when the class loaded
//    private static singleton.LazyLoadSingleton instance;
//
//    private singleton.LazyLoadSingleton() {}
//
//    public static singleton.LazyLoadSingleton getInstance() {
//        // create only when first requested
//        if (instance == null) {
//            instance = new singleton.LazyLoadSingleton();
//        }
//        return instance;
//    }
//}
...
//    public static synchronized singleton.LazyLoadSingleton getInstance() {
//        if (instance == null) {
//            instance = new singleton.LazyLoadSingleton();
//        }
//        return instance;
...
//    private static volatile singleton.LazyLoadSingleton instance;
//
//    private singleton.LazyLoadSingleton() {}
//
//    public static singleton.LazyLoadSingleton getInstance() {
...
//        if (instance == null) {
//            synchronized (singleton.LazyLoadSingleton.class) {
