...
public class PostController {
    ...
    public ResponseEntity<List<PostDto>> searchByContent(@RequestParam String keyword) {
        return ResponseEntity.ok(postService.searchPostsByContent(keyword));
    }
    @GetMapping("/search/content/native")
    public ResponseEntity<List<PostDto>> searchPostsByContentnative(@RequestParam String keyword) {
        return ResponseEntity.ok(postService.searchPostsByContentnative(keyword));
    }
}
