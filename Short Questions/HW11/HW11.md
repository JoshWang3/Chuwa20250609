...
Bean Is name of bean, config using @Bean(name = "userService") or @Component("userService"). It is used when lookup by name.



Bean Class is type of bean, used when lookup by type.
