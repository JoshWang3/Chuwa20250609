...
**I want to run queries in `http://localhost:8888` to be consistent with my `docker-compose.yml` setup:**

```bash
kubectl port-forward service/redbook-service 8888:8888 -n redbook-dev
```
