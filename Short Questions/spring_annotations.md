...
| `@ExceptionHandler` | Handles specific exceptions and maps them to responses                            |
| `@ControllerAdvice` | Defines global exception handling for controllers                                 |
...
| `@Pattern`                             | Validates a string field with a regular expression         |
...
| `@WithMockUser`                 | Mocks a user for Spring Security tests                            |
